...
public class GetUserByIdHandlerTests
{
    ...
    public async Task GetUserById_WithExistingUser_ShouldReturnUser()
    {
        ...
        _unitOfWorkMock.UserRepository.GetByIdAsync(Arg.Any<string>()).Returns(expectedResult);
        ...
        await _unitOfWorkMock.UserRepository.Received(1).GetByIdAsync(Arg.Is<string>(x => x == userId));
    }
    ...
    public async Task GetUserById_WithNonExistingUser_ShouldThrowKeyNotFoundException()
    {
        ...
        _unitOfWorkMock.UserRepository.GetByIdAsync(Arg.Any<string>()).Returns((User?)null);
